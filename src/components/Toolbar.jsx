...
const Toolbar = ({handleAddColumn, handleAddRow, handleRemoveColumn, handleRemoveRow, isSmallScreen, handleDeleteGrid, isDrawing, setIsDrawing, handleModeChange, isCanvasMode, wasDeleted}) => {
